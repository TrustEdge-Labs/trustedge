...
# Sealedge .seal Archive Verification WASM

> **STABLE** -- This crate is Tier 1 (Stable). Production-committed, tested in CI, and actively maintained.

WebAssembly bindings for sealedge .seal archive verification in web browsers, providing client-side cryptographic validation.
