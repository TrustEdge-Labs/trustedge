...
- [ ] **HTTP-01**: `/v1/verify` endpoint enforces a request body size limit (1-10 MB) via `RequestBodyLimitLayer`
- [ ] **HTTP-02**: HTTP endpoints enforce rate limiting to prevent CPU-exhaustion abuse of BLAKE3+Ed25519 verify
