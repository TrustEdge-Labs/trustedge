...
must_haves:
  truths:
    ...
    - "Ed25519 signing returns BackendError::UnsupportedOperation with clear message directing users to ECDSA P-256 or software backend (PIV hardware limitation)"
  artifacts:
