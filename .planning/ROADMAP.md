...
Plans:
- [x] 11-01-PLAN.md — Simulation tests in yubikey.rs #[cfg(test)] module (Wave 1)
- [x] 11-02-PLAN.md — Hardware integration tests in yubikey_integration.rs with #[ignore] (Wave 1)
